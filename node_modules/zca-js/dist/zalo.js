...
export class API {
    constructor(secretKey, zpwServiceMap, wsUrl) {
        ...
        this.blockUser = blockUserFactory(makeURL(`${zpwServiceMap.friend[0]}/api/friend/block`, {
            zpw_ver: appContext.API_VERSION,
            zpw_type: appContext.API_TYPE,
        }));
        this.unblockUser = unblockUserFactory(makeURL(`${zpwServiceMap.friend[0]}/api/friend/unblock`, {
            zpw_ver: appContext.API_VERSION,
            zpw_type: appContext.API_TYPE,
        }));
