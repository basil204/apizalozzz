...
function uploadAttachmentFactory(serviceURL) {
     ...
     * @throws ZaloApiError
     */
    return async function uploadAttachment(filePaths, threadId, type = Message.MessageType.DirectMessage) {
        ...
        const chunkSize = context.appContext.settings.features.sharefile.chunk_size_file;
        ...
        for (const filePath of filePaths) {
            ...
            switch (extFile) {
                ...
                case "webp":
                    ...
                    data.params.imei = context.appContext.imei;
        ...
        for (const data of attachmentsData) {
            for (let i = 0; i < data.params.totalChunk; i++) {
                ...
                requests.push(utils.request(utils.makeURL(url + urlType[data.fileType], Object.assign(query, { params: encryptedParams })), {
                    method: "POST",
                    ...
                    if (resData && resData.fileId != -1 && resData.photoId != -1)
                        await new Promise((resolve) => {
                            if (data.fileType == "video" || data.fileType == "others") {
                                ...
                                context.appContext.uploadCallbacks.set(resData.fileId, uploadCallback);
                            }
