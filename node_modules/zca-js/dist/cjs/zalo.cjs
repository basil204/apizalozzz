...
class API {
    constructor(secretKey, zpwServiceMap, wsUrl) {
        ...
        this.blockUser = blockUser.blockUserFactory(utils.makeURL(`${zpwServiceMap.friend[0]}/api/friend/block`, {
            zpw_ver: context.appContext.API_VERSION,
            zpw_type: context.appContext.API_TYPE,
        }));
        this.unblockUser = unblockUser.unblockUserFactory(utils.makeURL(`${zpwServiceMap.friend[0]}/api/friend/unblock`, {
            zpw_ver: context.appContext.API_VERSION,
            zpw_type: context.appContext.API_TYPE,
        }));
