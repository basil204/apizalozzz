...
function updateCookie(input) {
    ...
    const cookie = context.appContext.cookie;
...
function getDefaultHeaders() {
    ...
    return {
        ...
        Cookie: context.appContext.cookie,
        Origin: "https://chat.zalo.me",
        Referer: "https://chat.zalo.me/",
        "User-Agent": context.appContext.userAgent,
    };
}
async function request(url, options) {
    ...
    if (response.headers.has("set-cookie")) {
        ...
        if (newCookie)
            context.appContext.cookie = newCookie;
    }
    return response;
}
...
function getFullTimeFromMilisecond(e) {
    let t = new Date(e);
...
async function handleZaloResponse(response) {
    const result = {
        data: null,
        error: null,
    };
    ...
    try {
        ...
        const decodedData = JSON.parse(decodeAES(context.appContext.secretKey, jsonData.data));
...
exports.getFullTimeFromMilisecond = getFullTimeFromMilisecond;
